...
class PaymentService {
  ...
  completeOrder = async (body) => {
    console.log('completeOrder', body)
    ...
    const newOrder = await orderModel.create({ order_info: body, number_order: parseInt(nextNumberOrder) + parseInt(quantity?.global_value) });
    if (newOrder) {
